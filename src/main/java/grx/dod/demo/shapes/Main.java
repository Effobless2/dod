...
public class Main {
    public static void main(String[] args) {
        ...
        System.out.println(new AreaEmitter().output(new Mutation(Square.class).output(shapes)));
        System.out.println(new SpaceEmitter().output(new Mutation(Square.class).output(shapes)));
